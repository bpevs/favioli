  ...
  return (
    <Fragment>
      ...
      <p>
        ...
        computer, and does not modify anything outside of favicons.
      </p>
      <p>
      ...
      <p>
        ...
        <a href='https://github.com/ivebencrazy/favioli/issues'>Github</a>! In
        the future, we will try to add a button you can use to send this kind of
        thing. Since we do not collect any automated feedback, though, your
